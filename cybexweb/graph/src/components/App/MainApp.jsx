...
import { MacroCard, MacroCardInformationalContent, MacroCardActionContent } from '../MacroCard';
        ...
        <DataContext.Provider value={{ config: props.config, neo4jData, setNeo4jData }}>
          ...
          <AppContainer>
            ...
            <MenuBar side="left" icon="search">
              <h3
                style={{ paddingLeft: '0%', paddingRight: '25%', marginLeft: '30%', marginTop: '5%', color: 'white' }}
              >
                Macros
              </h3>
              ...
              <div style={{ padding: '5%' }}>
                <MacroCard>
                  ...
                  <MacroCardInformationalContent onClick={getPhishingMacro}>
                    <FontAwesomeIcon
                      size="lg"
                      icon={faPlayCircle}
                      color=""
                    ...
                    />
                  </MacroCardInformationalContent>
                  <MacroCardActionContent onClick={() => setMacroDetails('macro1')}>
                    <FontAwesomeIcon
                      size="lg"
                      icon={faInfoCircle}
                ...
                <MacroCard>
                  ...
                  <MacroCardActionContent onClick={() => setMacroDetails('macro2')}>
                    <FontAwesomeIcon
                      size="lg"
                      icon={faInfoCircle}
                ...
                {macroDetails == 'macro2' && (
                  ...
                  >
                    ...
                    <ul>
                      ...
                      <li>
                        NOTE: Currently, exposing related attributes found in CYBEX-P must be done manually on each
                        node. For that functionality, select a desired node and use the "Cybex Related" radial menu
                        option.
                      </li>
                    </ul>
                  </div>
