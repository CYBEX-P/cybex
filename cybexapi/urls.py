...
from . import views
from cybexapi.api import exportNeoDB, insert, delete, enrichNode, enrichNodePost, enrichURL, macroCybex, macro, wipe, start, startFile, importJson, position, dataEntry, getContents, currentUserInfo, orgInfo#, insertURL
...
urlpatterns = [
    ...
    path('api/v1/userManagement/currentUserInfo/<info_to_return>/', currentUserInfo.as_view()),
    path('api/v1/userManagement/orgInfo/<org_hash>/<return_type/', currentUserInfo.as_view()),
    ##post
